    ...
    Surface(color = MaterialTheme.colorScheme.background, modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            if (step == 0) {
                ...
                Spacer(Modifier.height(Space.m))
                Text(
                    "گوشی برای اینکه باتری بیشتر بمونه، برنامه‌هایی رو که یه مدت باز نکردی " +
                        "می‌خوابونه — و برنامهٔ خواب پیامک بانک رو همون لحظه نمی‌بینه. اگه " +
                        "اجازه بدی چقدر تومن بیدار بمونه، هر پیامک همون لحظه خونده می‌شه، " +
                        "وگرنه ممکنه تا چند ساعت بعد طول بکشه.",
                    fontSize = 15.sp,
                    lineHeight = 26.sp,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
